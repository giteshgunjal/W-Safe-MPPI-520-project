 ...
 *   + n2: 13
 *
 * Generated at: 2022-04-22 00:14:18.480002
 *
 */
#include <stdlib.h>
...
#define NP_NAVIGATION 443

/* Dimension of F1 (number of ALM constraints) */
#define N1_NAVIGATION 40

/* Dimension of F2 (number of PM constraints) */
#define N2_NAVIGATION 13

/* Dimension of xi = (c, y) */
#define NXI_NAVIGATION 41
 ...
 */
extern int phi_rkKCpxVzpHxFPGHSjmVE(
 ...
 */
extern int grad_phi_rkKCpxVzpHxFPGHSjmVE(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f1_rkKCpxVzpHxFPGHSjmVE(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f2_rkKCpxVzpHxFPGHSjmVE(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
...
int cost_function_navigation(const casadi_real** arg, casadi_real** res) {
    ...
    return phi_rkKCpxVzpHxFPGHSjmVE(
        args__,
        result_space_cost,
...
int grad_cost_function_navigation(const casadi_real** arg, casadi_real** res) {
    ...
    return grad_phi_rkKCpxVzpHxFPGHSjmVE(
        args__,
        result_space_grad,
...
int mapping_f1_function_navigation(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f1_rkKCpxVzpHxFPGHSjmVE
     * Implemented in: icasadi/extern/auto_casadi_mapping_f1.c
     */
    return mapping_f1_rkKCpxVzpHxFPGHSjmVE(
        args__,
        result_space_f1,
...
int mapping_f2_function_navigation(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f2_rkKCpxVzpHxFPGHSjmVE
     * Implemented in: icasadi/extern/auto_casadi_mapping_f2.c
     */
    return mapping_f2_rkKCpxVzpHxFPGHSjmVE(
        args__,
        result_space_f2,
