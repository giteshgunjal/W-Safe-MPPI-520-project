...
//
// Generated at: 2022-04-22 00:14:18.548883
//
...
pub const NAVIGATION_NUM_PARAMETERS: usize = 430;

/// Number of parameters associated with augmented Lagrangian
pub const NAVIGATION_N1: usize = 40;

/// Number of penalty constraints
pub const NAVIGATION_N2: usize = 13;
...
pub fn solve(
    ...
    let f1 = |u: &[f64], res: &mut [f64]| -> Result<(), SolverError> {
        icasadi_navigation::mapping_f1(u, p, res);
        Ok(())
    };
